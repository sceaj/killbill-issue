 ...
 * </pre>
 */
public class TestConfigurationHandler extends PluginTenantConfigurableConfigurationHandler<Properties> {

    private static final Logger logger = LoggerFactory.getLogger(TestConfigurationHandler.class);

    private final String region;

    public TestConfigurationHandler(final String region,
